...
CREATE TABLE IF NOT EXISTS `PHPDieppe`.`T_ARTICLES` (
  ...
  PRIMARY KEY (`ID_ARTICLES`, `T_USERS_ID_USER`, `T_USERS_ID_ROLE`),
...
CREATE TABLE IF NOT EXISTS `PHPDieppe`.`T_ARTICLES_has_T_CATEGORIES` (
  ...
  PRIMARY KEY (`T_ARTICLES_ID_ARTICLES`, `T_ARTICLES_T_USERS_ID_USER`, `T_ARTICLES_T_USERS_ID_ROLE`, `T_CATEGORIES_ID_CATEGORIES`),
  INDEX `fk_T_ARTICLES_has_T_CATEGORIES_T_CATEGORIES1_idx` (`T_CATEGORIES_ID_CATEGORIES` ASC),
  INDEX `fk_T_ARTICLES_has_T_CATEGORIES_T_ARTICLES1_idx` (`T_ARTICLES_ID_ARTICLES` ASC, `T_ARTICLES_T_USERS_ID_USER` ASC, `T_ARTICLES_T_USERS_ID_ROLE` ASC),
  CONSTRAINT `fk_T_ARTICLES_has_T_CATEGORIES_T_ARTICLES1`
    FOREIGN KEY (`T_ARTICLES_ID_ARTICLES` , `T_ARTICLES_T_USERS_ID_USER` , `T_ARTICLES_T_USERS_ID_ROLE`)
    REFERENCES `PHPDieppe`.`T_ARTICLES` (`ID_ARTICLES` , `T_USERS_ID_USER` , `T_USERS_ID_ROLE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
